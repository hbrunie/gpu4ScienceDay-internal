...
#pragma acc enter data create(aqsmtemp[0:aqsmtemp_size], vcoul[0:vcoul_size], inv_igp_index[0:inv_igp_index_size], indinv[0:indinv_size], \
    aqsntemp[0:aqsntemp_size], I_eps_array[0:I_eps_array_size], wx_array[nstart:nend], wtilde_array[0:wtilde_array_size])
