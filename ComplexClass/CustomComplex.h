...
class CustomComplex {
    ...
    dataType get_real() const
    {
        return this->x;
    }

    dataType get_imag() const
    {
        return this->y;
    }

    void set_real(dataType val)
    {
        this->x = val;
    }

    void set_imag(dataType val)
    {
        this->y = val;
    }
...
//2 flops
    ...
    CUDA_HOSTDEV
#endif
    friend inline CustomComplex<T> operator *(const CustomComplex<T> &a, const dataType &b) {
...
//2 flops
    ...
    CUDA_HOSTDEV
#endif
    friend inline CustomComplex<T> operator -(const dataType &a, CustomComplex<T>& src) {
    ...
    CUDA_HOSTDEV
#endif
    friend inline dataType CustomComplex_abs(const CustomComplex<T>& src) ;

    template<class T>
#ifdef __CUDACC__
    CUDA_HOSTDEV
#endif
    friend inline dataType CustomComplex_real( const CustomComplex<T>& src) ;

    template<class T>
#ifdef __CUDACC__
    CUDA_HOSTDEV
#endif
    friend inline dataType CustomComplex_imag( const CustomComplex<T>& src) ;
